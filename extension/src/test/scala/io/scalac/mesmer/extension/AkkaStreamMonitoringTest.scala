...
import io.scalac.mesmer.core.util.probe.{ Collected => CollectedObserver }
...
import io.scalac.mesmer.extension.util.probe
...
import io.scalac.mesmer.extension.util.probe.StreamMonitorTestProbe
import io.scalac.mesmer.extension.util.probe.StreamOperatorMonitorTestProbe
